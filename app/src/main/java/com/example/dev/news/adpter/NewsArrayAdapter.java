package com.example.dhrumilshah.news.adpter;
...
import com.example.dhrumilshah.news.R;
...
public class NewsArrayAdapter extends ArrayAdapter<News> {
    ...
    public NewsArrayAdapter(@NonNull Context context, @NonNull List<News> objects) {
